	...
	<header class="header-v4">
		...
		<div class="container-menu-desktop">
			...
			<div class="wrap-menu-desktop how-shadow1" style="top: 40px;">
				<nav class="limiter-menu-desktop container">
					...
					<!-- Logo desktop -->		
					<a href="#" class="logo">
						<img src="${pageContext.request.contextPath}/resources/images/icons/Gentle_monster_logo.png" alt="IMG-LOGO">
					</a>
		...
		<div class="wrap-header-mobile">
			...
			<div class="logo-mobile">
				<a href="index.html"><img src="${pageContext.request.contextPath}/resources/images/icons/Gentle_monster_logo.png" alt="IMG-LOGO"></a>
			</div>
